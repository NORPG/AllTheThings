	...
	expansion(EXPANSION.MID, bubbleDownSelf({ ["timeline"] = { ADDED_12_0_1_LAUNCH } }, {
		...
		n(QUESTS, {
			q(93692, {	-- Engineering Services Requested
				...
				["coords"] = {
					{ 43.5, 54.1, MAP_MIDNIGHT_SILVERMOON_CITY },
					{ 45.1, 55.1, MAP_MIDNIGHT_SILVERMOON_CITY },
				},
				["isWeekly"] = true,
				["groups"] = {
		...
		n(TREASURES, {
			o(525941, {	-- Ethereal Stormwrench
				["coord"] = { 54.0, 51.0, MAP_MIDNIGHT_SLAYERS_RISE_OUTDOOR },
				["questID"] = 89137,
				["groups"] = {
			...
			o(525942, {	-- Expeditious Pylon
				["coord"] = { 68.0, 49.8, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89136,
				["groups"] = {
			...
			o(525938, {	-- Handy Wrench
				["coord"] = { 34.2, 87.8, MAP_MIDNIGHT_ZULAMAN },
				["questID"] = 89140,
				["groups"] = {
			...
			o(525943, {	-- Manual of Mistakes and Mishaps
				["coord"] = { 39.6, 45.8, MAP_MIDNIGHT_EVERSONG_WOODS },
				["questID"] = 89135,
				["groups"] = {
			...
			o(525944, {	-- Miniaturized Transport Skiff
				["coord"] = { 28.9, 39.1, MAP_MIDNIGHT_SLAYERS_RISE_OUTDOOR },
				["questID"] = 89134,
				["groups"] = {
			...
			o(525940, {	-- Offline Helper Bot
				["coord"] = { 65.3, 35.0, MAP_MIDNIGHT_ATAL_AMAN_OUTDOOR },
				["questID"] = 89138,
				["groups"] = {
			...
			o(525945, {	-- One Engineer's Junk
				["coord"] = { 51.2, 74.6, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89133,
				["groups"] = {
			...
			o(525939, {	-- What To Do When Nothing Works
				["coord"] = { 51.3, 57.0, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89139,
				["groups"] = {
