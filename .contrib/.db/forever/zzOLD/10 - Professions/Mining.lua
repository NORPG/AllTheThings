...
root(ROOTS.Professions, prof(MINING, bubbleDownSelf({ ["requireSkill"] = MINING }, {
	...
	expansion(EXPANSION.MID, bubbleDownSelf({ ["timeline"] = { ADDED_12_0_1_LAUNCH } }, {
		...
		n(QUESTS, sharedData({
			...
			["coord"] = { 42.6, 52.9, MAP_MIDNIGHT_SILVERMOON_CITY },
			["isWeekly"] = true,
			["groups"] = {
