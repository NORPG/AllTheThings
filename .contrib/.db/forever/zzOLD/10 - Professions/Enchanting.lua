...
root(ROOTS.Professions, prof(ENCHANTING, bubbleDownSelf({ ["requireSkill"] = ENCHANTING }, {
	...
	expansion(EXPANSION.MID, bubbleDownSelf({ ["timeline"] = { ADDED_12_0_1_LAUNCH } }, {
		...
		n(QUESTS, sharedData({
			...
			["coord"] = { 48.0, 53.9, MAP_MIDNIGHT_SILVERMOON_CITY },
			["isWeekly"] = true,
			["groups"] = {
		...
		n(TREASURES, {
			o(525953, {	-- Enchanted Amani Mask
				["coord"] = { 48.4, 22.9, MAP_MIDNIGHT_ATAL_AMAN_OUTDOOR },
				["questID"] = 89100,
				["groups"] = {
			...
			o(525952, {	-- Enchanted Sunfire Silk
				["coord"] = { 40.2, 61.2, MAP_MIDNIGHT_EVERSONG_WOODS },
				["questID"] = 89101,
				["groups"] = {
			...
			o(525949, {	-- Entropic Shard
				["coord"] = { 37.7, 65.3, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89104,
				["groups"] = {
			...
			o(525950, {	-- Everblazing Sunmote
				["coord"] = { 60.8, 53.0, MAP_MIDNIGHT_EVERSONG_WOODS },
				["questID"] = 89103,
				["groups"] = {
			...
			o(525948, {	-- Primal Essence Orb
				["coord"] = { 65.8, 50.2, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89105,
				["groups"] = {
			...
			o(525951, {	-- Pure Void Crystal
				["coord"] = { 35.5, 58.8, MAP_MIDNIGHT_VOIDSTORM },
				["questID"] = 89102,
				["groups"] = {
			...
			o(525946, {	-- Sin'dorei Enchanting Rod
				["coord"] = { 63.5, 32.6, MAP_MIDNIGHT_EVERSONG_WOODS },
				["questID"] = 89107,
				["groups"] = {
