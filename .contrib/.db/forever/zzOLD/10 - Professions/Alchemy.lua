	...
	expansion(EXPANSION.MID, bubbleDownSelf({ ["timeline"] = { ADDED_12_0_1_LAUNCH } }, {
		...
		n(QUESTS, {
			q(93690, {	-- Alchemy Services Requested
				...
				["coords"] = {
					{ 45.0, 55.2, MAP_MIDNIGHT_SILVERMOON_CITY },
					{ 47.0, 52.0, MAP_MIDNIGHT_SILVERMOON_CITY },
				},
				["isWeekly"] = true,
				["groups"] = {
		...
		n(TREASURES, {
			o(525962, {	-- Failed Experiment
				["coord"] = { 32.8, 43.3, MAP_MIDNIGHT_VOIDSTORM },
				["questID"] = 89118,
				["groups"] = {
			...
			o(525965, {	-- Freshly Plucked Peacebloom
				["coord"] = { 49.1, 75.8, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89115,
				["groups"] = {
			...
			o(525964, {	-- Measured Ladle
				["coord"] = { 49.1, 23.6, MAP_MIDNIGHT_ATAL_AMAN_OUTDOOR },
				["questID"] = 89116,
				["groups"] = {
			...
			o(525963, {	-- Pristine Potion
				["coord"] = { 47.8, 51.8, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89117,
				["groups"] = {
			...
			o(525969, {	-- Vial of Eversong Oddities
				["coord"] = { 45.1, 44.9, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89111,
				["groups"] = {
			...
			o(525967, {	-- Vial of Rootlands Oddities
				["coord"] = { 34.8, 24.7, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89113,
				["groups"] = {
			...
			o(525968, {	-- Vial of Voidstorm Oddities
				["coord"] = { 41.9, 40.6, MAP_MIDNIGHT_SLAYERS_RISE_OUTDOOR },
				["questID"] = 89112,
				["groups"] = {
			...
			o(525966, {	-- Vial of Zul'Aman Oddities
				["coord"] = { 40.4, 51.1, MAP_MIDNIGHT_ZULAMAN },
				["questID"] = 89114,
				["groups"] = {
