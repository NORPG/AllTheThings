...
root(ROOTS.Professions, prof(SKINNING, bubbleDownSelf({ ["requireSkill"] = SKINNING }, {
	...
	expansion(EXPANSION.MID, bubbleDownSelf({ ["timeline"] = { ADDED_12_0_1_LAUNCH } }, {
		...
		n(QUESTS, sharedData({
			...
			["coord"] = { 43.2, 55.6, MAP_MIDNIGHT_SILVERMOON_CITY },
			["isWeekly"] = true,
			["groups"] = {
