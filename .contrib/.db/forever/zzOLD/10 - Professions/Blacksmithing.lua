	...
	expansion(EXPANSION.MID, bubbleDownSelf({ ["timeline"] = { ADDED_12_0_1_LAUNCH } }, {
		...
		n(QUESTS, {
			q(93691, {	-- Blacksmithing Services Requested
				...
				["coords"] = {
					{ 43.7, 51.8, MAP_MIDNIGHT_SILVERMOON_CITY },
					{ 45.1, 55.2, MAP_MIDNIGHT_SILVERMOON_CITY },
				},
				["isWeekly"] = true,
				["groups"] = {
		...
		n(TREASURES, {
			o(525959, {	-- Carefully Racked Spear
				["coord"] = { 33.2, 65.9, MAP_MIDNIGHT_ATAL_AMAN_OUTDOOR },
				["questID"] = 89179,
				["groups"] = {
			...
			o(525961, {	-- Deconstructed Forge Techniques
				["coord"] = { 26.9, 60.3, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89177,
				["groups"] = {
			...
			o(525958, {	-- Metalworking Cheat Sheet
				["coord"] = { 56.8, 40.8, MAP_MIDNIGHT_EVERSONG_WOODS },
				["questID"] = 89180,
				["groups"] = {
			...
			o(525956, {	-- Rutaani Floratender's Sword
				["coord"] = { 66.3, 50.9, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89182,
				["groups"] = {
			...
			o(525954, {	-- Silvermoon Blacksmith's Hammer
				["coord"] = { 48.5, 74.7, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89184,
				["groups"] = {
			...
			o(525960, {	-- Silvermoon Smithing Kit
				["coord"] = { 48.3, 75.8, MAP_MIDNIGHT_EVERSONG_WOODS },
				["questID"] = 89178,
				["groups"] = {
			...
			o(525955, {	-- Sin'dorei Master's Forgemace
				["coord"] = { 49.2, 61.3, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89183,
				["groups"] = {
			...
			o(525957, {	-- Voidstorm Defense Spear
				["coord"] = { 30.6, 69.0, MAP_MIDNIGHT_SLAYERS_RISE_OUTDOOR },
				["questID"] = 89181,
				["groups"] = {
