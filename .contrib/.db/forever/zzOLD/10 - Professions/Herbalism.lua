...
root(ROOTS.Professions, prof(HERBALISM, bubbleDownSelf({ ["requireSkill"] = HERBALISM }, {
	...
	expansion(EXPANSION.MID, bubbleDownSelf({ ["timeline"] = { ADDED_12_0_1_LAUNCH } }, {
		...
		n(QUESTS, sharedData({
			...
			["coord"] = { 48.3, 51.4, MAP_MIDNIGHT_SILVERMOON_CITY },
			["isWeekly"] = true,
			["groups"] = {
		...
		n(TREASURES, {
			o(525974, {	-- A Spade
				["coord"] = { 64.2, 30.5, MAP_MIDNIGHT_EVERSONG_WOODS },
				["questID"] = 89158,
				["groups"] = { i(238472) },	-- A Spade
			}),
			o(525970, {	-- Bloomed Bud
				["coord"] = { 38.3, 67.0, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89162,
				["groups"] = {
			...
			o(525975, {	-- Harvester's Sickle
				["coord"] = { 76.1, 51.1, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89157,
				["groups"] = {
			...
			o(525973, {	-- Lightbloom Root
				["coord"] = { 36.7, 25.1, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89159,
				["groups"] = {
			...
			o(525977, {	-- Planting Shovel
				["coord"] = { 51.1, 55.7, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89155,
				["groups"] = {
			...
			o(525972, {	-- Simple Leaf Pruners
				["coord"] = { 49.0, 75.9, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89160,
				["groups"] = {
			...
			o(525971, {	-- Sweeping Harvester's Scythe
				["coord"] = { 41.9, 46.0, MAP_MIDNIGHT_ZULAMAN},
				["questID"] = 89161,
				["groups"] = {
