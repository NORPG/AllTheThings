	...
	expansion(EXPANSION.MID, bubbleDownSelf({ ["timeline"] = { ADDED_12_0_1_LAUNCH } }, {
		...
		n(QUESTS, {
			q(93696, {	-- Tailoring Services Requested
				...
				["coords"] = {
					{ 45.1, 55.0, MAP_MIDNIGHT_SILVERMOON_CITY },
					{ 48.2, 54.0, MAP_MIDNIGHT_SILVERMOON_CITY },
				},
				["isWeekly"] = true,
				["groups"] = {
		...
		n(TREASURES, {
			o(525905, {	-- A Child's Stuffy
				["coord"] = { 70.5, 50.9, MAP_MIDNIGHT_HARANDAR },
				["questID"] = 89078,
				["groups"] = {
			...
			o(525904, {	-- A Really Nice Curtain
				["coord"] = { 35.9, 61.3, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89079,
				["groups"] = {
			...
			o(525898, {	-- Artisan's Cover Comb
				["coord"] = { 40.5, 49.4, MAP_MIDNIGHT_ZULAMAN },
				["questID"] = 89085,
				["groups"] = {
			...
			o(525901, {	-- Book of Sin'dorei Stitches
				["coord"] = { 62.0, 83.6, MAP_MIDNIGHT_SLAYERS_RISE_OUTDOOR },
				["questID"] = 89082,
				["groups"] = {
			...
			o(525899, {	-- Particularly Enchanting Tablecloth
				["coord"] = { 31.8, 68.2, MAP_MIDNIGHT_SILVERMOON_CITY },
				["questID"] = 89084,
				["groups"] = {
			...
			o(525900, {	-- Satin Throw Pillow
				["coord"] = { 61.6, 85.0, MAP_MIDNIGHT_SLAYERS_RISE_OUTDOOR },
				["questID"] = 89083,
				["groups"] = {
			...
			o(525903, {	-- Sin'dorei Outfitter's Ruler
				["coord"] = { 46.3, 34.8, MAP_MIDNIGHT_EVERSONG_WOODS },
				["questID"] = 89080,
				["groups"] = {
			...
			o(525902, {	-- Wooden Weaving Sword
				["coord"] = { 69.8, 51.0, MAP_MIDNIGHT_HARANDAR },
