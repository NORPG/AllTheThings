		...
		["groups"] = {
			...
			petbattles({
				n(66522, {	-- Lydia Accoste <Grand Master Pet Tamer>
					["coord"] = { 40.2, 76.6, MAP.DEADWIND_PASS },
				...
				q(31915, {	-- Grand Master Lydia Accoste
					...
					["coord"] = { 40.0, 76.4, MAP.DEADWIND_PASS },
					["timeline"] = { ADDED_5_0_4 },
					["groups"] = {
			...
			n(QUESTS, {
				q(44154, {	-- The Rite of the Executioner
					...
					["coord"] = { 38.7, 73.9, MAP.DEADWIND_PASS },
			...
			n(QUESTS, {
				applyclassicphase(SOD_PHASE_TWO, q(80120, {	-- A Service to Dalaran
					...
					["coord"] = { 52.0, 34.2, MAP.DEADWIND_PASS },
					["groups"] = {
						i(217014, {	-- Supply Bag
			...
			n(RARES, {
				applyclassicphase(SOD_PHASE_TWO, n(218931, {	-- Dark Rider
					...
					["coord"] = { 43.0, 29.0, MAP.DEADWIND_PASS },
					["groups"] = {
						i(216945),	-- Curious Dalaran Relic
					},
				})),
			...
			n(TREASURES, {
				o(421150, {	-- Carved Eye
					...
					["coord"] = { 43.9, 72.8, MAP.DEADWIND_PASS },
			...
			n(TREASURES, {
				applyclassicphase(SOD_PHASE_FOUR, i(226406, {	-- Rune of Sword Specialization
					...
					["coord"] = { 43.1, 74.6, MAP.DEADWIND_PASS },
			...
			n(VENDORS, {
				applyclassicphase(TBC_PHASE_ONE, n(18255, {	-- Mage Darius
					["coord"] = { 47.2, 75.0, MAP.DEADWIND_PASS },
					["groups"] = {
