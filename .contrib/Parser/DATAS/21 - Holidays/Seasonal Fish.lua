	...
	applyevent(EVENTS.SEASONAL_FISH_SUMMER_BASS, n(createHeader({
		...
		["groups"] = {
			i(13756, {	-- Raw Summer Bass
				["description"] =
					-- #if AFTER CATA
					"Can be caught in open sea water in Blasted Lands and Swamp of Sorrows from 20th March to 22nd September.",
					-- #else
					"Can be caught in open sea water in Azshara, Tanaris, The Hinterlands, Feralas, and STV from 20th March to 22nd September.",
					-- #endif
			}),
		},
	})),
	applyevent(EVENTS.SEASONAL_FISH_WINTER_SQUID, n(createHeader({
		...
		["groups"] = {
			i(13755, {	-- Winter Squid
				["description"] =
					-- #if AFTER CATA
					"Can be caught in open sea water in Blasted Lands and Swamp of Sorrows from 23nd September to 20th March.",
					-- #else
					"Can be caught in open sea water in Azshara, Tanaris, The Hinterlands, Feralas, and STV from 23nd September to 20th March.",
					-- #endif
			}),
		},
	})),
