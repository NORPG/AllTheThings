...
local appName, _ = ...
_.FlightPathDB=
{["FlightPathMapIDs"]={12,13,94,97,100,118,424,1922,993,1011,1014,1647,1409,2057,2149,2276,2298,2481,2480,2479,2540}}
_.OnInitDB=
{
	["GenerateCompareOtherKey_185693"] = function(t)t.otherItemID=185693 t.GetItemCount=function(t)return C_Item.GetItemCount(t.itemID,true)+ C_Item.GetItemCount(t.otherItemID,true)end	return t end
}
_.OnTooltipDB=
{
